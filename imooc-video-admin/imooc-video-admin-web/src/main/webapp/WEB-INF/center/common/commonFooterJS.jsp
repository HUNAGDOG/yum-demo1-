...
<!-- <input type="hidden" id="apiServer" name="apiServer" value="http://192.168.3.2:8081"/> 
<input type="hidden" id="bgmServer" name="bgmServer" value="http://192.168.3.2:8080/mvc"/> -->
<input type="hidden" id="apiServer" name="apiServer" value="https://www.18smart.cn/yum"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://123.206.8.132/mvc"/>
